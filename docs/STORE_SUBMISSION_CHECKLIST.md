...
- [ ] Production wrapper builds pass `-SupportEmailVerified` or set
      `FLOWFIT_SUPPORT_EMAIL_VERIFIED=true` only after an external test email
      proves that inbox can receive mail.
