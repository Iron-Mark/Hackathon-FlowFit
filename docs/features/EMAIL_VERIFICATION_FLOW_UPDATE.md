...
- Configured URL schemes: `com.msiazondev.flowfit` and `com.msiazondev.flowfit.dev`
...
- Supports both production (`com.msiazondev.flowfit://auth-callback`) and development (`com.msiazondev.flowfit.dev://auth-callback`) schemes
...
2. Link opens app with scheme: `com.msiazondev.flowfit://auth-callback?token=...`
