...
This comprehensive usage guide covers all major patterns and use cases for the YOLO Flutter plugin. For current FlowFit integration details, see the [YOLO camera integration guide](../../code/lib/features/yolo_camera/INTEGRATION_GUIDE.md).
