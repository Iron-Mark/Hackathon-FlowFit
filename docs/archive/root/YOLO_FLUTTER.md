...
**[Download Models](../../code/lib/features/yolo_camera/MODEL_SETUP.md)** |
...
- **[Usage Guide](../../code/lib/features/yolo_camera/INTEGRATION_GUIDE.md)** - Advanced patterns and examples
- **API Reference** - Refer to the installed `ultralytics_yolo` package API
- **Performance** - See the current YOLO camera implementation notes
